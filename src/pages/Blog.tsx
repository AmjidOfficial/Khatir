...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Insights & Blog | Khatir Real Estate & Builders"
        description="Insights on architecture, sustainable design and urban planning from Khatir Real Estate & Builders."
        path="/blog"
      />
      <Navigation />
